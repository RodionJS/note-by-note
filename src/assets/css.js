...
export const plusCSS =
  "rounded-full m-auto mt-1.5 sm:mt-auto sm:-translate-y-3 sm:scale-125 mb-auto bg-gray-400 text-white duration-[375ms] hover:bg-white hover:text-gray-400 shadow-gray-500 shadow-sm hover:shadow-md hover:shadow-gray-600 transition-all active:scale-90 sm:active:scale-110 cursor-pointer";
